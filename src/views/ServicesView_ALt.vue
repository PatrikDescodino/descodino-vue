  ...
  <div class="services-page">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                ...
                <div class="lg:col-span-2 space-y-6">
                  <div class="flex items-start justify-between">
                    <div>
                      ...
                      <p class="text-xl text-gray-dark">
                        Pro tech firmy, které potřebují
                        <strong>profesionální brandový základ</strong>
                        pro fundraising a růst
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Co získáte -->
                    <div>
                      <h3 class="text-xl font-700 mb-4 text-dark">Co získáte za 2-3 měsíce:</h3>
                      <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                          <span class="text-secondary mt-1 text-lg">✓</span>
                          <div>
                            <strong>Tech Brand Strategy</strong><br />
                            <span class="text-gray-dark text-sm"
                              >Positioning pro tech trh, konkurenční analýza, value
                              proposition</span
                            >
                          </div>
                        </li>
                        ...
                        <li class="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <span class="text-gray-dark text-sm"
                              >8-12 stránek, responsive design, CMS, SEO optimalizace</span
                            >
                          </div>
                        </li>
                        <li class="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <span class="text-gray-dark text-sm"
                              >20+ stran dokumentace, digitální templates</span
                            >
                          </div>
                        </li>
                        <li class="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div class="space-y-4">
                        <div class="flex items-center gap-3">
                          ...
                          <span class="text-gray-dark">Zvýšení důvěryhodnosti u investorů</span>
                        </div>
                        <div class="flex items-center gap-3">
                          <div class="text-2xl font-800 text-secondary">2-3x</div>
                          <span class="text-gray-dark">Lepší konverze webových návštěvníků</span>
                        </div>
                        <div class="flex items-center gap-3">
                          <div class="text-2xl font-800 text-secondary">-50%</div>
                          <span class="text-gray-dark"
                            >Snížení času na přípravu pitch materiálů</span
                          >
                        </div>
                      </div>
                      ...
                      <div class="mt-6 p-4 bg-secondary/10 rounded-lg">
                        <p class="text-sm">
                          <strong>Ideální pro:</strong> Pre-seed/Seed startupy, firmy 10-30 lidí,
                          první fundraising
                        </p>
                        <p class="text-sm"><strong>Doba realizace:</strong> 2-3 měsíce</p>
                        <p class="text-sm">
                          <strong>Garance:</strong> 3 revizní kola, 30 dní post-launch podpora
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="text-center lg:text-right">
                  <div class="bg-white p-6 rounded-xl shadow-sm border">
                    <div class="mb-4">
                      ...
                      <div class="text-4xl font-800 text-primary">180-220k Kč</div>
                      <div class="text-sm text-gray-600">Průměr: 200k Kč</div>
                    </div>
                    <button
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start pt-4">
                ...
                <div class="lg:col-span-2 space-y-6">
                  <div class="flex items-start justify-between">
                    <div>
                      ...
                      <p class="text-xl text-gray-dark">
                        Pro tech firmy připravené na
                        <strong>rychlý růst, Series A a mezinárodní expanzi</strong>
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Co získáte -->
                    <div>
                      <h3 class="text-xl font-700 mb-4 text-dark">Co získáte za 3-4 měsíce:</h3>
                      <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                          <span class="text-primary mt-1 text-lg">✓</span>
                          <div>
                            <strong>Vše z Tech Essentials balíčku</strong>
                          </div>
                        </li>
                        <li class="flex items-start gap-3">
                          <span class="text-primary mt-1 text-lg">✓</span>
                          <div>
                            ...
                            <span class="text-gray-dark text-sm"
                              >15-20 stránek, CRM integrace, analytics, automation</span
                            >
                          </div>
                        </li>
                        <li class="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div class="space-y-4">
                        <div class="flex items-center gap-3">
                          ...
                          <span class="text-gray-dark">Úspěšnost při fundraisingu</span>
                        </div>
                        <div class="flex items-center gap-3">
                          <div class="text-2xl font-800 text-primary">3-5x</div>
                          <span class="text-gray-dark">Více kvalifikovaných leadů</span>
                        </div>
                        <div class="flex items-center gap-3">
                          <div class="text-2xl font-800 text-primary">+45%</div>
                          <span class="text-gray-dark">Zlepšení employee advocacy</span>
                        </div>
                      </div>

                      <div class="mt-6 p-4 bg-primary/10 rounded-lg">
                        <p class="text-sm">
                          <strong>Ideální pro:</strong> Series A firmy, firmy 30-80 lidí, pre-IPO
                          příprava
                        </p>
                        <p class="text-sm"><strong>Doba realizace:</strong> 3-4 měsíce</p>
                        <p class="text-sm">
                          <strong>Garance:</strong> 5 revizních kol, 60 dní post-launch podpora
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="text-center lg:text-right">
                  <div class="bg-white p-6 rounded-xl shadow-sm border">
                    <div class="mb-4">
                      <div class="text-sm text-gray-600">Investice</div>
                      <div class="text-4xl font-800 text-primary">280-350k Kč</div>
                      <div class="text-sm text-gray-600">Průměr: 315k Kč</div>
                    </div>
                    <button
                    ...
                    <p class="text-gray-600 text-sm">
                      Nejčastěji volený balíček pro tech firmy v růstové fázi
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                ...
                <div class="lg:col-span-2 space-y-6">
                  <div class="flex items-start justify-between">
                    <div>
                      ...
                      <p class="text-xl text-gray-dark">
                        Pro tech firmy s <strong>ambicemi na tržní dominanci</strong> a mezinárodní
                        úspěch
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Co získáte -->
                    <div>
                      <h3 class="text-xl font-700 mb-4 text-dark">Co získáte za 4-6 měsíců:</h3>
                      <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                          <span class="text-secondary mt-1 text-lg">✓</span>
                          <div>
                            <strong>Vše ze Scale Ready balíčku</strong>
                          </div>
                        </li>
                        <li class="flex items-start gap-3">
                          <span class="text-secondary mt-1 text-lg">✓</span>
                          <div>
                            ...
                            <span class="text-gray-dark text-sm"
                              >Adaptace pro různé geografické trhy</span
                            >
                          </div>
                        </li>
                        <li class="flex items-start gap-3">
                        ...
                        <li class="flex items-start gap-3">
                          <span class="text-secondary mt-1 text-lg">✓</span>
                          <div>
                            <strong>6 měsíců strategických konzultací</strong><br />
                            <span class="text-gray-dark text-sm"
                              >Měsíční reviews a optimalizace</span
                            >
                          </div>
                        </li>
                        <li class="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3">
                          ...
                          <span class="text-gray-dark">Návratnost investice v prvním roce</span>
                        </div>
                        <div class="flex items-center gap-3">
                          <div class="text-2xl font-800 text-secondary">-60%</div>
                          <span class="text-gray-dark">Snížení CAC díky silné značce</span>
                        </div>
                      </div>

                      <div class="mt-6 p-4 bg-secondary/10 rounded-lg">
                        <p class="text-sm">
                          <strong>Ideální pro:</strong> Series B+, firmy 80+ lidí, mezinárodní
                          expanze, IPO příprava
                        </p>
                        <p class="text-sm"><strong>Doba realizace:</strong> 4-6 měsíců</p>
                        <p class="text-sm">
                          <strong>Garance:</strong> Unlimited revize, 6 měsíců ongoing podpora
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="text-center lg:text-right">
                  <div class="bg-white p-6 rounded-xl shadow-sm border">
                    <div class="mb-4">
                      <div class="text-sm text-gray-600">Investice</div>
                      <div class="text-4xl font-800 text-primary">420-550k Kč</div>
                      <div class="text-sm text-gray-600">Průměr: 485k Kč</div>
                    </div>
                    <button
                      class="btn-primary w-full mb-4 hover:bg-secondary transition-colors"
                    ...
                    <p class="text-gray-600 text-sm">
                      Pro firmy, které chtějí dominovat svému trhu
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 gap-4">
                ...
                <div v-if="results.roi > 0" class="mt-6">
                  ...
                  >
                    ...
                    <span class="text-sm bg-white/20 px-2 py-1 rounded">{{
                      calculator.selectedPackage.replace('-', ' ').toUpperCase()
                    }}</span>
                  </button>
                ...
                >
                  <div class="h-full flex items-start justify-center p-4 pt-8 pb-8">
                    <div
                      class="bg-white rounded-2xl w-full max-w-5xl shadow-2xl flex flex-col"
                      style="max-height: calc(100vh - 4rem)"
                    >
                      <!-- Modal Header - FIXED -->
                      <div
                        class="bg-gradient-to-r from-primary to-red-700 text-white p-6 rounded-t-2xl flex-shrink-0"
                      >
                        <div class="flex justify-between items-start">
                          <div class="flex-1">
                            <h3
                              class="text-2xl lg:text-3xl font-black mb-2 flex items-center gap-3"
                            >
                              <span class="text-2xl lg:text-3xl">🚀</span>
                              Objednávka brandingové služby
                            </h3>
                            <div
                              class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-red-100"
                            >
                              <span class="text-lg font-semibold">
                                {{ getPackageTitle(calculator.selectedPackage) }}
                              </span>
                              <span
                                class="bg-white/20 px-4 py-2 rounded-full text-lg font-bold w-fit"
                              >
                      ...
                      <div class="flex-1 overflow-y-auto">
                        <div class="p-6 lg:p-8 space-y-6 lg:space-y-8">
                          ...
                          <div
                            class="bg-gradient-to-br from-green-50 to-blue-50 border-2 border-green-200 p-6 rounded-2xl"
                          >
                            <h4
                              class="font-black text-xl lg:text-2xl mb-4 flex items-center gap-3 text-gray-800"
                            >
                              <span class="text-2xl">📊</span>
                              Vaše kalkulace ROI
                            </h4>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                              <div
                                class="bg-primary/10 p-4 rounded-xl text-center border border-primary/20"
                              >
                                <div class="text-xl lg:text-2xl font-black text-primary mb-1">
                                  +{{ formatCurrency(results.incrementalProfit) }}
                                </div>
                                <div class="text-xs lg:text-sm text-primary font-semibold">
                                  měsíčně navíc
                                </div>
                              </div>
                              <div
                                class="bg-green-100 p-4 rounded-xl text-center border border-green-300"
                              >
                                <div class="text-xl lg:text-2xl font-black text-green-700 mb-1">
                                  {{ (results.roi * 100).toFixed(0) }}%
                                </div>
                                <div class="text-xs lg:text-sm text-green-700 font-semibold">
                                  ROI za {{ calculator.horizon }}m
                                </div>
                              </div>
                              <div
                                class="bg-blue-100 p-4 rounded-xl text-center border border-blue-300"
                              >
                                <div class="text-xl lg:text-2xl font-black text-blue-700 mb-1">
                                  ...
                                  }}{{ results.paybackPeriod !== Infinity ? 'm' : '' }}
                                </div>
                                <div class="text-xs lg:text-sm text-blue-700 font-semibold">
                                  doba návratnosti
                                </div>
                              </div>
                            </div>
                            ...
                            <details class="group">
                              <summary
                                class="cursor-pointer text-primary font-semibold hover:text-red-700 transition-colors list-none flex items-center gap-2"
                              >
                                <svg
                                  class="w-4 h-4 transform group-open:rotate-90 transition-transform"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
                              ...
                              <div class="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div class="bg-white p-4 rounded-xl border border-gray-300">
                                  <h5
                                    class="font-bold mb-3 text-gray-800 flex items-center gap-2 text-sm"
                                  >
                                  ...
                                  <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                      ...
                                      <span class="font-semibold text-gray-900">{{
                                        formatNumber(calculator.baselineTraffic)
                                      }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                      <span class="text-gray-700">Konverze:</span>
                                      <span class="font-semibold text-gray-900"
                                        >{{ calculator.baselineConversion }}%</span
                                      >
                                    </div>
                                    <div class="flex justify-between">
                                      <span class="text-gray-700">AOV:</span>
                                      <span class="font-semibold text-gray-900">{{
                                        formatCurrency(calculator.averageOrder)
                                      }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                      <span class="text-gray-700">Marže:</span>
                                      <span class="font-semibold text-gray-900"
                                        >{{ calculator.profitMargin }}%</span
                                      >
                                    </div>
                                ...
                                <div class="bg-green-50 p-4 rounded-xl border border-green-400">
                                  <h5
                                    class="font-bold mb-3 text-green-900 flex items-center gap-2 text-sm"
                                  >
                                  ...
                                  <div class="space-y-2 text-sm">
                                    ...
                                    <div
                                      class="flex justify-between pt-2 border-t border-green-400"
                                    >
                          ...
                          >
                            <h4
                              class="font-black text-xl lg:text-2xl flex items-center gap-3 text-gray-800"
                            >
                              <span class="text-2xl">👤</span>
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                              <div class="flex items-start gap-3">
                                ...
                                <label class="text-sm text-gray-700 leading-relaxed">
                                  <strong>Souhlasím se zpracováním osobních údajů</strong> za účelem
                                  kontaktování a zpracování poptávky.
                                  <a
                                    href="/gdpr"
                                    target="_blank"
                                    class="text-primary hover:underline font-semibold"
                                    >Více o zpracování údajů</a
                                  >
                                </label>
                              </div>
                            </div>
                      ...
                      <div
                        class="bg-gray-50 p-4 lg:p-6 border-t border-gray-200 rounded-b-2xl flex-shrink-0"
                      >
                        <div class="flex gap-3 lg:gap-4">
                          ...
                          >
                            <span v-if="isSubmitting" class="animate-spin text-xl lg:text-2xl"
                              >⏳</span
                            >
      ...
      <div class="container-custom relative z-10">
        <div class="text-center mb-16">
          ...
          <p class="body-lg text-gray-dark max-w-3xl mx-auto">
            Transparentní proces od prvního hovoru po finální implementaci. Každý krok má jasné
    ...
    <section class="py-20 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="text-center mb-16">
          <div
            class="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-full text-sm font-semibold mb-6"
          >
            <span class="text-2xl">⚡</span>
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Odpovědi na nejčastější dotazy o našem přístupu k brandingu, procesu spolupráce a
            filosofii
        ...
        <div class="space-y-4">
          <!-- FAQ Item 1 -->
          <div
            class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-gray-300"
          >
            <button
              @click="toggleFaq(0)"
            ...
            <div v-if="openFaq === 0" class="px-8 pb-8 -mt-4">
              <div class="ml-14 pt-4 border-t border-gray-100">
                <p class="text-gray-700 leading-relaxed text-lg">
                  Nejsme jen designové studio. Jsme brandoví architekti digitálního věku, kteří
                  kombinují DESign + CODe + INOvation. Naše DCI filosofie znamená, že nevytváříme
                  jen krásné věci, ale komplexní brandové ekosystémy s technologickou páteří. Učíme
          ...
          >
            ...
            >
              <div class="flex-shrink-0 mt-1">
                <div
                  class="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center text-white"
                >
                  <span class="text-xl">📈</span>
                </div>
              </div>
            ...
            <div v-if="openFaq === 1" class="px-8 pb-8 -mt-4">
              <div class="ml-14 pt-4 border-t border-gray-100">
                <p class="text-gray-700 leading-relaxed text-lg">
                  Specializujeme se na dlouhodobé projektové zakázky 3-12 měsíců. Náš proces má 4
                  fáze: Brandová strategie (1-2m) → Kreativní koncept (1-2m) → Digitální
                  implementace (2-4m) → Launch & optimalizace (1-3m). Nejde nám o rychlé řešení, ale
                  o udržitelnou transformaci vaší značky.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div v-if="openFaq === 2" class="px-8 pb-8 -mt-4">
              <div class="ml-14 pt-4 border-t border-gray-100">
                <p class="text-gray-700 leading-relaxed text-lg">
                  Specializujeme se na tech firmy, ale rádi spolupracujeme s ambiciózními značkami z
                  jakéhokoli oboru, které sdílejí naši vizi moderního brandingu. Pokud hledáte
                  strategický přístup, technologickou vyspělost a inovativní řešení, budeme rádi,
                  když si promluvíme o vašem projektu.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div v-if="openFaq === 3" class="px-8 pb-8 -mt-4">
              <div class="ml-14 pt-4 border-t border-gray-100">
                <p class="text-gray-700 leading-relaxed text-lg">
                  Každý projekt zahrnuje komplexní předání know-how, brandové guidelines a školení
                  vašeho týmu. Poskytujeme post-launch podporu a nabízíme pokračující spolupráci
                  formou brandových konzultací, měsíční péče nebo rychlých projektů. Nezůstanete
                  sami - jsme vaši průvodci v digitálním světě.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div v-if="openFaq === 4" class="px-8 pb-8 -mt-4">
              <div class="ml-14 pt-4 border-t border-gray-100">
                <p class="text-gray-700 leading-relaxed text-lg">
                  Naším hlavním zaměřením jsou komplexní brandové transformace, které přinášejí
                  skutečnou hodnotu. Pokud máte jasnou vizi a chcete budovat značku systematicky,
                  rádi si promluvíme o tom, jak můžeme spolupracovat a postupně rozšiřovat naše
                  partnerství.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div v-if="openFaq === 5" class="px-8 pb-8 -mt-4">
              <div class="ml-14 pt-4 border-t border-gray-100">
                <p class="text-gray-700 leading-relaxed text-lg">
                  Měříme reálný dopad na váš business - od zvýšení hodnoty značky přes lepší
                  fundraising možnosti až po efektivnější komunikaci s klienty. Náš cíl není jen
                  hezký design, ale značka, která vám pomože dosáhnout vašich business cílů a
                  vyprávět příběh, který lidi skutečně zajímá.
                </p>
              </div>
            </div>
          </div>
